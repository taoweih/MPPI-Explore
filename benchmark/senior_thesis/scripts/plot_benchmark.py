...
Usage:
    python3 -m benchmark.senior_thesis.scripts.plot_benchmark <benchmark_dir> [options]

Examples:
    # All controllers, all metrics, both sweeps (default)
    python3 -m benchmark.senior_thesis.scripts.plot_benchmark \
        benchmark/senior_thesis/data/runs/u_point_mass_benchmark_thesis_2026_04_12_20_29_25

    # Only MPPI and Density, only horizon sweep, only frequency
    python3 -m benchmark.senior_thesis.scripts.plot_benchmark <dir> \
        --controllers "MPPI" "Density-Guided MPPI" --sweep horizon --metrics frequency

    # Multiple metrics
    python3 -m benchmark.senior_thesis.scripts.plot_benchmark <dir> \
        --metrics success_rate frequency

Output: benchmark/senior_thesis/data/plots/<task>_<ctrl_tag>_<sweep>_<metric>.png
"""
...
os.environ.setdefault("MPLCONFIGDIR", str(Path(tempfile.gettempdir()) / "mppi_matplotlib"))
...
from benchmark.common.paths import plots_dir
...
def main():
    ...
    parser.add_argument(
        ...
        help="Output directory (default: senior thesis plots data directory)",
    )
    ...
    out_dir = (
        ...
        else plots_dir("senior_thesis", output_root=args.output_root)
    )
