...
Extracts the heatmap region from archive/visualize/u_point_mass/learned_value_step_*.png,
crops to the U obstacle + goal area, strips axes/colorbar/title, adds a
time label, and saves clean panels to thesis_plots.

Usage:
    python3 -m benchmark.senior_thesis.scripts.u_point_vis_util
"""
...
def main():
    ...
    for step in STEPS:
        src = args.input_dir / f"learned_value_step_{step:05d}.png"
        if not src.exists():
